...
- **데이터명**: 서울시 실시간 도시데이터 
- **출처**: [서울 열린데이터광장](https://data.seoul.go.kr/dataList/OA-21285/A/1/datasetView.do#)  
- **설명**: 서울시 실시간 도시데이터는 실시간 인구현황, 도로소통현황, 주차장 현황, 지하철 실시간 도착 현황, 버스정류소 현황, 사고통제현황, 따릉이 현황, 날씨 현황, 전기차충전소 현황, 문화행사 현황 정보를 제공함
